package com.arvent.order.logging;
...
public class LoggingAdvice {
    ...
    @Pointcut(value = "execution(* com.arvent.order.controller..*(..))")
    ...
    @Around("execution(* com.arvent.order.service.*..*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.arvent.order.controller..*(..))", throwing = "ex")
